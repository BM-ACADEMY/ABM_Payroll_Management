...
import { LayoutDashboard, Users, UserCheck, CreditCard, Settings, PieChart, ChevronLeft, ChevronRight } from "lucide-react";

const Sidebar = ({ user, isCollapsed, setIsCollapsed, isMobile }) => {
  const adminLinks = [
  ...
  return (
    <>
      ...
      <aside 
        className={`fixed left-0 top-0 h-screen transition-all duration-300 ease-in-out bg-indigo-950 border-r border-indigo-900 z-50 flex flex-col p-4 shadow-2xl ${
          isMobile 
