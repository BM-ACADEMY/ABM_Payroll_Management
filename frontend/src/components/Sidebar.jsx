...
const Sidebar = ({ user }) => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-slate-950 border-r border-slate-900 z-50 flex flex-col p-6">
      ...
      <div className="mt-auto pt-6 border-t border-slate-900">
        <div className="px-4 py-3 flex items-center gap-3 text-slate-500">
